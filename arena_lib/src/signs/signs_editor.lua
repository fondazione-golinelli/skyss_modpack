...
core.register_tool("arena_lib:sign_add", {
...
core.register_tool("arena_lib:sign_remove", {
    ...
    on_use = function(itemstack, user, pointed_thing)
      ...
      core.show_formspec(p_name, "arena_lib:sign_delete", get_sign_formspec(arena_name))
    end
})



core.register_tool("arena_lib:sign_teleport_in", {
...
core.register_tool("arena_lib:sign_teleport_out", {
