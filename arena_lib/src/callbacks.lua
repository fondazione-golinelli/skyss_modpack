-- I had no idea how to do it, so this is how Luanti handles global callbacks :D
...
function arena_lib.on_region_trespass(mod, func)
  arena_lib.mods[mod].on_region_trespass = func
end
