...
core.register_tool("arena_lib:editor_players", {
    ...
    on_use = function(itemstack, user)
      ...
      if arena.teams_enabled and (mod_ref.can_disable_teams or mod_ref.variable_teams_amount) then
        core.chat_send_player(user:get_player_name(), core.colorize("#ffdddd", "[arena_lib] " .. S("Values are PER TEAM! Use item #4 to change value")))
      end
...
core.register_tool("arena_lib:editor_spawners", {
...
core.register_tool("arena_lib:editor_map", {
  description = S("Map"),
...
core.register_tool("arena_lib:editor_customise", {
...
core.register_tool("arena_lib:editor_settings", {
...
core.register_tool("arena_lib:editor_info", {
...
core.register_tool("arena_lib:editor_return", {
...
core.register_tool("arena_lib:editor_enable", {
...
core.register_tool("arena_lib:editor_quit", {
