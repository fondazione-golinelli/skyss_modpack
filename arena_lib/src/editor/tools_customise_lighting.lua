...
core.register_tool("arena_lib:customise_lighting", {
    ...
    on_use = function(itemstack, user, pointed_thing)
      ...
      core.show_formspec(p_name, "arena_lib:lighting", get_lighting_formspec(p_name))
    end
})
...
core.register_on_player_receive_fields(function(player, formname, fields)
  ...
  if fields.light then
    temp_light.light = core.explode_scrollbar_event(fields.light).value / 100
  end

  if fields.saturation then
    temp_light.shaders.saturation = core.explode_scrollbar_event(fields.saturation).value / 100
  end
