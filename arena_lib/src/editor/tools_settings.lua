...
core.register_tool("arena_lib:settings_returnpoint", {
...
core.register_tool("arena_lib:settings_rename_author", {
    ...
    on_use = function(itemstack, user, pointed_thing)
      ...
      core.show_formspec(user:get_player_name(), "arena_lib:settings_rename_author_thumbnail", get_rename_author_thumbnail_formspec(arena))
    end
})



core.register_tool("arena_lib:settings_properties", {
    ...
    on_use = function(itemstack, user, pointed_thing)
      ...
      core.show_formspec(p_name, "arena_lib:settings_properties", get_properties_formspec(p_name, mod, arena, 1))
    end
})



core.register_craftitem("arena_lib:timer", {
    ...
    on_use = function(itemstack, user, pointed_thing)
      ...
      core.show_formspec(user:get_player_name(), "arena_lib:settings_timer", get_timer_formspec(time))
    end
})



core.register_tool("arena_lib:settings_delete", {
    ...
    on_use = function(itemstack, user, pointed_thing)
      ...
      core.show_formspec(p_name, "arena_lib:settings_delete", get_delete_formspec(p_name, arena_name))
    end
})
...
core.register_on_player_receive_fields(function(player, formname, fields)
  ...
  elseif formname == "arena_lib:settings_properties" then
    ...
    if fields.arena_properties then
      ...
      local expl = core.explode_textlist_event(fields.arena_properties)

      if expl.type == "DCL" or expl.type == "CHG" then
        core.show_formspec(p_name, "arena_lib:settings_properties", get_properties_formspec(p_name, mod, arena, expl.index))
      end
    ...
    elseif fields.property_overwrite or fields.key_enter then
      ...
      core.show_formspec(p_name, "arena_lib:settings_properties", get_properties_formspec(p_name, mod, arena, sel_property_attr[p_name].id))
    end
