...
core.register_tool("arena_lib:spawner_add", {
...
core.register_tool("arena_lib:spawner_remove", {
...
core.register_tool("arena_lib:spawner_team_add", {
...
core.register_tool("arena_lib:spawner_team_remove", {
...
core.register_tool("arena_lib:spawner_team_switch", {
  ...
  on_use = function(itemstack, user, pointed_thing)
    ...
    core.chat_send_player(user:get_player_name(), S("Selected team: @1", arena_lib.mods[mod].teams[team_ID]))
...
core.register_tool("arena_lib:spawner_deleteall", {
...
core.register_tool("arena_lib:spawner_team_deleteall", {
...
function arena_lib.give_spawners_tools(player)
  ...
  if arena.teams_enabled then
    ...
    core.chat_send_player(player:get_player_name(), S("Selected team: @1", arena_lib.mods[mod].teams[1]))
  else
