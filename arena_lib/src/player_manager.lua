...
core.register_on_joinplayer(function(player)
  ...
  if p_inv:contains_item("main", "arena_lib:editor_quit") then
    ...
    if core.get_modpath("hub") then return end          -- se c'è Hub, ci pensa quest'ultimo allo svuotamento dell'inventario
  ...
  if crashed_players[p_name] and arena_lib.get_arena_by_matchID(crashed_players[p_name]) then
    core.show_formspec(p_name, "arena_lib:rejoin", get_rejoin_formspec())
  end
...
core.register_on_player_receive_fields(function(player, formname, fields)
  ...
  if fields.quit or fields.cancel then
    ...
    core.close_formspec(p_name, "arena_lib:rejoin")
